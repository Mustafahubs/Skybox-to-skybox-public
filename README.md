...
This downloads the latest release, verifies its SHA256 checksum, installs it to `%LOCALAPPDATA%\SkyboxToSkybox`, adds Start Menu and Desktop shortcuts, and launches it. Safe to re-run any time to reinstall/force-update — just close the app first if it's currently running.
